...
// -------
//
function ciniki_lapt_flags(&$ciniki) {
    //
    // The flags for the object
    //
    $flags = array(
        // 0x01
        array('flag'=>array('bit'=>'1', 'name'=>'Types')),
        array('flag'=>array('bit'=>'2', 'name'=>'Categories')),
        array('flag'=>array('bit'=>'3', 'name'=>'Tags')),
//        array('flag'=>array('bit'=>'4', 'name'=>'')),
        // 0x10
//        array('flag'=>array('bit'=>'5', 'name'=>'Steps')),    // Tutorial steps **future**
